  ...
  return (
    <div className="min-h-screen pb-24 fade-in">
      ...
      {/* MODAL DE ACCIONES (editar/eliminar) — siempre centrado abajo,
          ...
          Usa safe-area-inset-bottom + padding generoso para no quedar
          tapado por la barra de navegacion del sistema operativo. */}
      {menuAbierto && (
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/60" onClick={() => setMenuAbierto(null)}>
          <div
            className="w-full max-w-[420px] bg-[#FFFCF8] rounded-t-2xl p-2"
      ...
      {modal && (
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/60" onClick={() => { setModal(null); setEditandoId(null) }}>
          <div
            className="w-full max-w-[480px] bg-[#FFFCF8] rounded-t-2xl p-5 space-y-4 max-h-[90vh] overflow-y-auto"
