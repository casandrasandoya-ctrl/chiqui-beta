...
// ============================================================
// generar_396_orden_observaciones.js
// ============================================================
...
const VARIANTES_PREV = [
  {
    viejo: "  const obsActivas = obs.filter(o => o.estado === 'activa')",
    nuevo: [
      ...
      "",
      "  const obsActivas = ordenarPorActualizacion(obs.filter(o => o.estado === 'activa'))",
    ].join('\n'),
  },
  {
