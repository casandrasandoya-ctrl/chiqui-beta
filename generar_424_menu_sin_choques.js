...
// ============================================================
// generar_424_menu_sin_choques.js
// ============================================================
...
// Los dos botones de mes tienen que seguir. Se comprueba que EXISTAN,
// no cuantas veces: cambiarMes tambien puede llamarse desde el swipe o
// desde un boton de "hoy", y exigir exactamente una aparicion hacia
// abortar sin motivo.
if (!cal.includes('cambiarMes(-1)')) {
  abortar('se perdio el boton de mes anterior.');
}
if (!cal.includes('cambiarMes(1)')) {
  abortar('se perdio el boton de mes siguiente.');
}
