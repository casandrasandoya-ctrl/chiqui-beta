...
// ============================================================
// generar_384_completar_anchos.js
// ============================================================
// QUE PASO CON EL 382
...
// Se mira una pieza que SOLO existe en este bloque. La clase suelta
// 'flex flex-wrap gap-1.5' ya existia en otra parte del archivo (los
// cuidados o los signos), y por eso el 382 aborto creyendo que ya
// estaba hecho: estaba mirando otro bloque.
...
// Cada requerido apunta a algo UNICO de este bloque. Buscar la clase
// suelta 'flex flex-wrap gap-1.5' daba falso positivo porque ya existia
// en otra seccion del archivo.
const REQUERIDOS = [
  'mx-4 mt-2 flex flex-wrap gap-1.5',
